...
namespace CodePen
{
	...
	void uiTitleBar::OnAttach()
	{
		...
		if (ThemeManager::IsDarkTheme())
			m_Logo->LoadFromFile("H:/Projects/CppProject/CodePen-Studio/Core/Resources/Images/CodePenStudio_White.png");
		else
			m_Logo->LoadFromFile("H:/Projects/CppProject/CodePen-Studio/Core/Resources/Images/CodePenStudio_Black.png");
