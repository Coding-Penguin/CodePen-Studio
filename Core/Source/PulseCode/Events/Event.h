...
namespace PulseCode {
	...
	/*
	* Events in PulseCode Studio are currently blocking, meaning when an event occurs it immediately gets dispatched and must be dealt with right then and there.
